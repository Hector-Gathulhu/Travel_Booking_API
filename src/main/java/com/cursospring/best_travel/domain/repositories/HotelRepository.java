...
import com.cursospring.best_travel.domain.entities.HotelEntity;
...
public interface HotelRepository extends JpaRepository<HotelEntity,Long> {
    ...
    Optional<HotelEntity> findByReservationsId(UUID id);//This is a Join query with inclusive spring data language
